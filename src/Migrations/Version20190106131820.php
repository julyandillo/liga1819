 ...
 */
final class Version20190106131820 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_DF3A8544E2ABE6E6 ON estadistica (id_equipo)');
        $this->addSql('CREATE INDEX IDX_DF3A8544BF4FB5CF ON estadistica (id_jornada)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DF3A8544E2ABE6E6 ON estadistica');
        $this->addSql('DROP INDEX IDX_DF3A8544BF4FB5CF ON estadistica');
    }
}
